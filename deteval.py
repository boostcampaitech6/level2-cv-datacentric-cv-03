        ...
        for gtNum in range(len(recallMat)):
            if (
                ...
                if (
                    ...
                    >= eval_hparams["AREA_RECALL_CONSTRAINT"]
                ):
                ...
                for gtNum in range(len(gtRects)):
                    for detNum in range(len(detRects)):
                        ...
                        recallMat[gtNum, detNum] = (
                            0
                            if rgDimensions == 0
                            else intersected_area / rgDimensions
                        )
                        precisionMat[gtNum, detNum] = (
                            0
                            if rdDimensions == 0
                            else intersected_area / rdDimensions
                        )

                recall_cond = (
                    recallMat >= eval_hparams["AREA_RECALL_CONSTRAINT"]
                )
                precision_cond = (
                            ...
                            if match is True:
                                ...
                                if is_single_overlap(gtNum, detNum) is True:
                                    ...
                                    if (
                                        ...
                                        gtRectMat[gtNum] = 1
                                        detRectMat[detNum] = 1
                                        recallAccum += eval_hparams[
                                            "MTYPE_OO_O"
                                        ]
                                        precisionAccum += eval_hparams[
                                            "MTYPE_OO_O"
                                        ]
                                        pairs.append(
                                            {

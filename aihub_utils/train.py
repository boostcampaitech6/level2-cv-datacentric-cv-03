...
def do_training(
    ...
    # train_loader = iter(filtered_data)
    ########################################
    ...
    model.load_state_dict(
        torch.load(
            "/data/ephemeral/home/code/trained_models/latest_aihub_sampledata_150e.pth"
        )
    )  # Load the state dict # latest_aihub_sampledata_150e.pth
